...
class CrossEncoderReranker:
    ...
    def rerank(
        ...
        settings = get_settings()
        top_k = min(top_k or settings.rerank_top_k, len(documents))
        ...
        try:
            ...
            # Actualizar scores en metadata y retornar top_k
            reranked_docs = []
            for doc, new_score in doc_scores[:top_k]:
            ...
            # En caso de error, retornar los documentos originales
