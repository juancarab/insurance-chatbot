...
AGENT_SYSTEM_PROMPT = (
    ...
    "5. If after consulting the tools there is not enough information, say it clearly and ask for more details "
    "   (for example, the exact plan name or the specific terms/conditions).\n"
